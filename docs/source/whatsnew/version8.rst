...
Small release for this end of november;
 ...
 - :pr:`14579` improve the documentatation for cutom IPython formatters, and how
   you can register formatters for custo mime types.
 - :pr:`14580` fix a bug in which commands that were not assigned a shortcut
   could not be assigned one.
 - :pr:`12690` fix a bug in which a single ``/`` on an empty line would not be
